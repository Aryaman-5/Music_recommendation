...
const westernData = [
  ...
  {
    title: "Battalia a 10 in D Major",
    composer: "Biber",
    mood: "delightful",
    tags: ["baroque", "orchestral"],
  },
  {
    title: "Brandenburg Concerto No. 5",
    composer: "Bach",
    mood: "delightful",
    tags: ["baroque", "concerto"],
  },
  {
  ...
  // Need to wake up
  {
    ...
    composer: "Grieg",
    mood: "wakeup",
    tags: ["orchestral", "sunrise"],
  },
  {
    title: "Summer",
    composer: "Vivaldi",
    mood: "wakeup",
    tags: ["violin", "energetic"],
  },
  {
    title: "Buckaroo Holiday",
    composer: "Copland",
    mood: "wakeup",
    tags: ["orchestral", "chaotic"],
  },
  ...
  // Feeling proud
  {
    ...
    composer: "Elgar",
    mood: "proud",
    tags: ["orchestral", "ceremonial"],
  },
  {
    title: "Symphony No. 9",
    composer: "Beethoven",
    mood: "proud",
    tags: ["choral", "ode-to-joy"],
  },
  {
    title: "1812 Overture",
    composer: "Tchaikovsky",
    mood: "proud",
    tags: ["orchestral", "cannons"],
  },
  {
    title: "Symphony No. 5, Finale",
    composer: "Tchaikovsky",
    mood: "proud",
    tags: ["orchestral", "triumphant"],
  },
  {
    title: "American",
    composer: "Dvořák",
  ...
  {
    title: "Symphony No. 10 Mvt. 2",
    composer: "Shostakovich",
    mood: "angry",
    tags: ["orchestral", "tense"],
  },
  {
    title: "Symphony No. 5",
    composer: "Beethoven",
  ...
  {
    title: "Quartet No. 8, Mvt. 2",
    composer: "Shostakovich",
    mood: "angry",
    tags: ["string quartet", "haunting"],
  },
  {
    title: "Young Person’s Guide to the Orchestra, Fugue",
    composer: "Britten",
    mood: "angry",
    tags: ["orchestral", "complex"],
  },

  // Want to cry
  {
    title: "Fantasia Based on Russian Themes",
    composer: "Rimsky-Korsakov",
    mood: "cry",
    tags: ["orchestral", "melancholy"],
  },
  {
    title: "Adagio for Strings",
    composer: "Barber",
    mood: "cry",
    tags: ["strings", "mournful"],
  },
  {
    title: "Violin Concerto in E Minor",
    composer: "Mendelssohn",
    mood: "cry",
    tags: ["violin", "emotional"],
  },
  {
    title: "Aase’s Death",
    composer: "Grieg",
    mood: "cry",
    tags: ["orchestral", "funereal"],
  },
  {
  ...
  // Want chills
  {
    ...
    composer: "Saint-Saëns",
    mood: "chills",
    tags: ["orchestral", "spooky"],
  },
  {
    title: "Russian Easter Overture",
    composer: "Rimsky-Korsakov",
    mood: "chills",
    tags: ["orchestral", "festive"],
  },
  ...
  },
  {
    ...
    composer: "Rimsky-Korsakov",
    mood: "study",
    tags: ["orchestral", "storytelling"],
  },
  {
    title: "Pines of Rome, Mvt. 4",
    composer: "Respighi",
    mood: "study",
    tags: ["orchestral", "majestic"],
  },
  ...
  // Emotional
  {
    ...
    composer: "Saint-Saëns",
    mood: "emotional",
    tags: ["violin", "passionate"],
  },
  {
    title: "Unfinished Symphony",
    composer: "Schubert",
    mood: "emotional",
    tags: ["symphony", "mysterious"],
  },
  {
    title: "Symphony No. 7, Allegretto",
    composer: "Beethoven",
    mood: "emotional",
    tags: ["symphony", "haunting"],
  },
  {
    title: "Canon in D",
    composer: "Pachelbel",
    mood: "emotional",
    tags: ["strings", "repetitive"],
  },

  // Relax with tea
  {
    title: "St. Paul’s Suite",
    composer: "Holst",
    mood: "relax",
    tags: ["strings", "peaceful"],
  },
  {
  ...
  {
    title: "L’Arlésienne Suite",
    composer: "Bizet",
    mood: "relax",
    tags: ["orchestral", "gentle"],
  },
  ...
  },
  {
    ...
    composer: "Borodin",
    mood: "misc",
    tags: ["orchestral", "folk"],
  },
  {
    title: "Enigma Variations",
    composer: "Elgar",
    mood: "misc",
    tags: ["orchestral", "puzzles"],
  },
  {
  ...
  },
  {
    ...
    composer: "Paganini",
    mood: "cool",
    tags: ["violin", "difficult"],
  },
  {
    title: "New World Symphony, Allegro con Fuoco",
    composer: "Dvořák",
    mood: "cool",
    tags: ["symphony", "dramatic"],
  },
...
function showRecommendations(filterValue) {
  ...
  allMusic
    ...
    .forEach((piece) => {
      ...
      const searchQuery = piece.composer
        ? encodeURIComponent(`${piece.title} ${piece.composer}`)
        : encodeURIComponent(piece.title);
...
function createRatingStars(piece) {
  let stars = "";
  for (let i = 1; i <= 5; i++) {
    stars += `<span onclick="ratePiece('${piece.title}', ${i})">${
      i <= (piece.rating || 0) ? "★" : "☆"
    }</span>`;
  }
  return stars;
